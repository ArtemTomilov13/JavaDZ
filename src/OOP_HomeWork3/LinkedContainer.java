...
public class LinkedContainer<E>  implements  Linked<E>, Iterable<E>, DescendingIterator<E>{
    public static void main(String[] args) {
        ...
        stringLinked.addFirst("1");
        stringLinked.addFirst("2");
        stringLinked.addFirst("3");
        stringLinked.addFirst("4");
        stringLinked.addLast("5");
        stringLinked.addLast("6");
        stringLinked.addLast("7");
        stringLinked.addLast("8");
